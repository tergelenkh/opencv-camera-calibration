...
K = np.array([[973.76678888, 0.00, 642.19383273],
              [0.00, 974.24352556, 356.24437884],
              [0.00, 0.00, 1.00]]) # Derived from `calibrate_camera.py`
dist_coeff = np.array([0.02540085, 0.19082725, -0.00251992, 0.00328693, -1.38991081])
